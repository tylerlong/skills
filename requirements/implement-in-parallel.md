...
4. When no Worker Agents remain:
   ...
   - Otherwise, call the Skill tool with "review-result" to review all commits created by Worker Agents against the Parent Ticket spec. Then comment on and close the Parent Ticket, and stop.
